...
export default function UsersStats({ stats }) {
  ...
  const CARDS = [
    { icon: Users,        label: 'Total Users',   value: stats.total,     color: 'from-indigo-500 to-purple-500' },
    { icon: UserCheck,    label: 'Active',        value: stats.active,    color: 'from-emerald-500 to-teal-500'  },
    { icon: UserPlus,     label: 'Pending',       value: stats.pending,   color: 'from-yellow-500 to-orange-500' },
    { icon: ShieldCheck,  label: '2FA Enabled',   value: stats.twoFactor, color: 'from-blue-500 to-cyan-500'     },
  ];
